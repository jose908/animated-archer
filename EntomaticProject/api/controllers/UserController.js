  ...
  signup: function(req, res) {
    ...
    User.findOne({
      ...
      if (user) {
        ...
        res.badRequest('Inserted user is already in use');
          ...
          success: function (encryptedPassword) {
            ...
            User.create({
              ...
              if (err) {
                ...
                // If this is a uniqueness error about the user attribute,
                // send back an easily parseable status code.
                if (err.invalidAttributes && err.invalidAttributes.user && err.invalidAttributes.user[0]
                  && err.invalidAttributes.user[0].rule === 'unique') {
